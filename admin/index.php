...
function adminPage()
{
    if(hasPermission('canAccountEdit'))
    {
    
        if(!isset($_SESSION['clientId']))
        {
            redirect("/user?func=set_client");
            return;
        }
    ...
    {
        $_SESSION['clientId']  = getUserSession('accountId');
        $_SESSION['clientName']= getUserSession('accountShortName');
        userHome();
    }
}
